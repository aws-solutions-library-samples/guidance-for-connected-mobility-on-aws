...
def check_s3_buckets(session, account):
    ...
    required = [
        ...
        (f'cms-{STAGE}-vfo-knowledge-base-{REGION}-{account}', 'VFO knowledge base - PDFs and markdown docs'),
        (f'cms-{STAGE}-transform-manifests-{REGION}-{account}', 'transform manifests + campaign collection schemes'),
    ]
