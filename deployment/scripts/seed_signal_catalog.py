...
# These 9 signals are added to the CMS BASE catalog (not OEM1-only) so future OEMs inherit them.
OEM1_SIGNALS = [
    ...
    ('WaterInFuelStatus',            'maintenance',    'Water-in-fuel sensor status (0=clear, 1=water detected)', None),
