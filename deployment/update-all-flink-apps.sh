#!/bin/bash
# ====================================================================
# >>> DEPRECATED 2026-06-08: CDK source is now source-of-truth for
# >>> Flink application_configuration property maps.
# >>> See spec 2026-06-08-cms-flink-cfn-config-keys-fix.
# >>> Use `cdk deploy cms-staging-flink` for property-map changes.
# >>> Use `make configure-flink` for JAR-only fast-path rotation.
# >>> This script is kept on disk for one release cycle as a
# >>> recovery escape hatch and will be removed in a follow-on spec.
# ====================================================================
