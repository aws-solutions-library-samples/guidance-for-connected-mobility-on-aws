...
class CommandsStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        catalog.add_method('GET', integration)

        # /api/commands/{vehicleId}
        vehicle_cmd = cmd_res.add_resource('{vehicleId}')
        vehicle_cmd.add_method('POST', integration)  # send command
        vehicle_cmd.add_method('GET', integration)    # get history

        # /api/geofences
        gf_res = api_res.add_resource('geofences')
        gf_res.add_method('POST', integration)  # create geofence
        gf_vehicle = gf_res.add_resource('{vehicleId}')
        gf_vehicle.add_method('GET', integration)     # list geofences for vehicle
        gf_vehicle.add_method('DELETE', integration)   # delete geofence
