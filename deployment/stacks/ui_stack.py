...
"""),
        ...
        fleet_api_kwargs = {
            ...
            'environment': {
                ...
                # self-service allowlist (claim a vehicle). Off by default; the
                # staging deploy sets DRIVER_SELF_GUARD_ENABLED=true. Claim-based
                # (not pool-id based) so it works in the consolidated pool where
                # the iOS app and Fleet UI share one Cognito pool.
                'DRIVER_SELF_GUARD_ENABLED': os.environ.get('DRIVER_SELF_GUARD_ENABLED', 'false'),
