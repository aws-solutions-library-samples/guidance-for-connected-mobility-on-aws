...
class PredictiveAgentStack(Stack):
    ...
    def _create_api_gateway(self) -> apigateway.RestApi:
        ...
        analysis_resource.add_method("POST", analysis_integration)
        analysis_resource.add_method("GET", analysis_integration)
        ...
        fleet_analysis_resource.add_method("POST", fleet_integration)
        ...
        schedule_resource.add_method("POST", schedule_integration)
        schedule_resource.add_method("GET", schedule_integration)
