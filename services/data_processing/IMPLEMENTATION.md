...
- **S3 Bucket**: `cms-{stage}-transform-manifests-{region}-{account}`
  - Versioned
...
3. **Output**
   ...
   └── Manifests Bucket: cms-dev-transform-manifests-us-west-2-123456789012
   ```
...
# Check S3 bucket
aws s3 ls s3://cms-dev-transform-manifests-us-west-2-123456789012/manifests/ \
  --profile your-profile
```
