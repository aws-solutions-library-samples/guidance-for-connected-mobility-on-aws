...
class EnhancedHistoricalDataInjector:
    ...
    def _load_real_drivers(self) -> List[Dict]:
        ...
        Per spec 2026-05-29-staging-drivers-simulator-cognito-parity
        Decision 4, the simulator no longer auto-creates phantom drivers
        when the drivers table is empty. Operators must run
        `make seed-drivers DEPLOYMENT_STAGE=$DEPLOYMENT_STAGE
        AWS_REGION=$AWS_REGION` before starting the historical injector.
        """
        try:
