...
public class FWTelemetryProcessor {
    ...
    public static void execute(String[] args) throws Exception {
        ...
        String vehiclesTable = params.get("TABLE_NAME", "cms-prod-storage-vehicles");
        String decoderTable = params.get("DECODER_TABLE", "cms-prod-decoder-manifest");
        ...
        return MANIFEST_SIGNALS.computeIfAbsent(decoderSyncId, syncId -> {
            ...
            try {
                ...
                QueryRequest req = QueryRequest.builder()
                        ...
                        .build();
                QueryResponse resp = getDdb(region).query(req);
                for (Map<String, AttributeValue> item : resp.items()) {
