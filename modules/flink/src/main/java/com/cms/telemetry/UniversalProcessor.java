    ...
    public static void main(String[] args) throws Exception {
        ...
        switch (processorType) {
            ...
            case "TelemetryDataProcessor":
                ...
                TelemetryDataProcessor.main(args);
                break;
            ...
            case "FWTelemetryProcessor":
                ...
                FWTelemetryProcessor.execute(args);
                break;

            case "SimulatorPreprocessor":
                LOG.info("🔧 Routing to SimulatorPreprocessor...");
                System.out.println("🔧 Routing to SimulatorPreprocessor...");
                SimulatorPreprocessor.execute(args);
                break;

            case "CampaignSyncProcessor":
                LOG.info("🔧 Routing to CampaignSyncProcessor...");
                System.out.println("🔧 Routing to CampaignSyncProcessor...");
                CampaignSyncProcessor.main(args);
                break;

            case "GeofenceProcessor":
                LOG.info("🔧 Routing to GeofenceProcessor...");
                System.out.println("🔧 Routing to GeofenceProcessor...");
                GeofenceProcessor.main(args);
                break;
                
            default:
                String errorMsg = "❌ Unknown processor type: " + processorType + 
                    ". Valid types: EventDrivenTelemetryProcessor, TelemetryDataProcessor, TripProcessor, SafetyProcessor, MaintenanceProcessor, OEMTelemetryProcessor, FWTelemetryProcessor, SimulatorPreprocessor, CampaignSyncProcessor, GeofenceProcessor";
                LOG.error(errorMsg);
