...
export const APP_TRADEMARK_NAME = "Connected Mobility Intelligence";
...
export const UI_ROUTES = {
  ...
  // Agent Workspace (Connect CCP + Nova Sonic handover)
  AGENT_WORKSPACE: "/agent-workspace",

  // Engineer persona — Product Digital Thread closed loop
  ENGINEERING_INSIGHTS: "/engineering",
  ENGINEERING_INVESTIGATE: "/engineering/investigate",
  ENGINEERING_DESIGN_OPTIONS: "/engineering/design-options",

  // Digital Thread — visibly separate destination (mocked PLM/sim/PRD writeback)
  DIGITAL_THREAD: "/digital-thread",
};

// Cognito User Pool Groups
// Canonical group definitions live in deployment/stacks/ui_stack.py:243-258
// (platform-admin / fleet-operator / fleet-viewer). The legacy ADMIN + AGENT
// keys below have App.tsx consumers (lines 1364 + 1415) and are kept as-is
// pending a separate role-reconciliation pass — see spec
// .kiro/specs/2026-06-09-cms-fleet-manager-cognito-role/decisions.md.
// FLEET_MANAGER and PRODUCT_ENGINEER were removed 2026-06-09 (zero consumers).
export const USER_GROUPS = {
  ...
  // Dispatcher — narrow, READ-ONLY monitoring persona. Sees exactly:
  // Vehicles, Vehicle Map, Fleets, Drivers, Service, Safety in the
  // sidebar (no dividers, no Settings link — the top-nav gear icon
  // remains for theme/sim prefs). Added 2026-07-17 for the prod
  // demo persona kevin.dispatch@example.com — see spec
...
export const IG_ROOT =
  "https://docs.aws.amazon.com/guidance/latest/connected-mobility-on-aws/solution-overview.html";
