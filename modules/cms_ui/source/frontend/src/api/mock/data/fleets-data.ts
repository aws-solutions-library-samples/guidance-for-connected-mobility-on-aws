...
export const SIGNAL_CATALOG_NODES: Record<string, any[]> = {
  "test_signal_catalog": [
    {
      fullyQualifiedName: "Vehicle",
      nodePath: "Vehicle",
      nodeType: "BRANCH",
      description: "Root node for vehicle signals",
      children: [
        {
          fullyQualifiedName: "Vehicle.Powertrain",
          nodePath: "Vehicle.Powertrain",
          nodeType: "BRANCH",
          description: "Powertrain signals",
          parentFullyQualifiedName: "Vehicle",
          children: [
            {
              fullyQualifiedName: "Vehicle.Powertrain.Engine",
              nodePath: "Vehicle.Powertrain.Engine",
              nodeType: "BRANCH",
              description: "Engine signals",
              parentFullyQualifiedName: "Vehicle.Powertrain",
              children: [
                {
                  fullyQualifiedName: "Vehicle.Powertrain.Engine.Speed",
                  nodePath: "Vehicle.Powertrain.Engine.Speed",
                  nodeType: "SENSOR",
                  dataType: "FLOAT",
                  ...
                  min: 0,
                  max: 10000,
                  parentFullyQualifiedName: "Vehicle.Powertrain.Engine",
                  children: []
                },
                {
                  fullyQualifiedName: "Vehicle.Powertrain.Engine.Temperature",
                  nodePath: "Vehicle.Powertrain.Engine.Temperature",
                  nodeType: "SENSOR",
                  dataType: "FLOAT",
            ...
            {
              fullyQualifiedName: "Vehicle.Powertrain.Transmission",
              nodePath: "Vehicle.Powertrain.Transmission",
              nodeType: "BRANCH",
              description: "Transmission signals",
              parentFullyQualifiedName: "Vehicle.Powertrain",
              children: [
                {
                  fullyQualifiedName: "Vehicle.Powertrain.Transmission.Gear",
                  nodePath: "Vehicle.Powertrain.Transmission.Gear",
                  nodeType: "SENSOR",
                  dataType: "INT8",
                  description: "Current gear",
                  parentFullyQualifiedName: "Vehicle.Powertrain.Transmission",
                  children: []
                }
              ]
            }
        ...
        {
          fullyQualifiedName: "Vehicle.Chassis",
          nodePath: "Vehicle.Chassis",
          nodeType: "BRANCH",
          description: "Chassis signals",
          parentFullyQualifiedName: "Vehicle",
          children: [
            {
              fullyQualifiedName: "Vehicle.Chassis.Brake",
              nodePath: "Vehicle.Chassis.Brake",
              nodeType: "BRANCH",
              description: "Brake signals",
              parentFullyQualifiedName: "Vehicle.Chassis",
              children: [
                {
                  fullyQualifiedName: "Vehicle.Chassis.Brake.PedalPosition",
                  nodePath: "Vehicle.Chassis.Brake.PedalPosition",
                  nodeType: "SENSOR",
                  dataType: "FLOAT",
                  description: "Brake pedal position as percentage",
                  unit: "%",
                  min: 0,
                  max: 100,
                  parentFullyQualifiedName: "Vehicle.Chassis.Brake",
                  children: []
                }
              ]
            },
            {
              fullyQualifiedName: "Vehicle.Chassis.SteeringWheel",
              nodePath: "Vehicle.Chassis.SteeringWheel",
              nodeType: "BRANCH",
              ...
              children: [
                {
                  ...
                  nodePath: "Vehicle.Chassis.SteeringWheel.Angle",
                  nodeType: "SENSOR",
                  dataType: "FLOAT",
                  ...
                  min: -720,
                  max: 720,
                  parentFullyQualifiedName: "Vehicle.Chassis.SteeringWheel",
                  children: []
                }
              ]
            }
          ...
          children: [
            {
              ...
              nodePath: "Vehicle.Body.Lights",
              nodeType: "BRANCH",
              description: "Light signals",
              parentFullyQualifiedName: "Vehicle.Body",
              children: [
                {
                  fullyQualifiedName: "Vehicle.Body.Lights.Headlight",
                  nodePath: "Vehicle.Body.Lights.Headlight",
                  nodeType: "ACTUATOR",
                  dataType: "BOOLEAN",
                  description: "Headlight status",
                  parentFullyQualifiedName: "Vehicle.Body.Lights",
                  children: []
                },
                {
                  fullyQualifiedName: "Vehicle.Body.Lights.Brake",
                  nodePath: "Vehicle.Body.Lights.Brake",
                  nodeType: "ACTUATOR",
                  dataType: "BOOLEAN",
