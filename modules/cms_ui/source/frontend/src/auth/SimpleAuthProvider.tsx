                ...
                <div style={{ borderTop: '1px solid #e9ebed', paddingTop: '16px', marginTop: '8px' }}>
                  ...
                  <SpaceBetween size="xs">
                    ...
                    */}
                    ...
                    {/* Quick-fill buttons: shown in DEV builds OR when runtimeConfig.showDemoButtons
                        is true (set by CDK for non-prod stages). Password is Demo-1234 for all
                        staging personas. NEVER shown in prod — CDK gates on DEPLOYMENT_STAGE. */}
