...
import { FleetDataSource, getFleetDataSource } from '@/types/fleet-types';
 ...
 *
 * Source-of-truth: Fleet Management API via ApiContext.client (rev 3 A3).
 ...
 */
const FleetPicker: React.FC<FleetPickerProps> = ({ onChange, label = 'Fleet', dataSourceFilter }) => {
