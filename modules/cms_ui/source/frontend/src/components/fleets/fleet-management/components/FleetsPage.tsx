    ...
    <SpaceBetween size="l">
      ...
      <Grid gridDefinition={[{ colspan: 3 }, { colspan: 3 }, { colspan: 3 }, { colspan: 3 }]}>
        <Container header={<Header variant="h2">Total Fleets</Header>}>
          ...
          <Box variant="small" color="text-body-secondary">{activeFleets} active fleets</Box>
          <Box variant="small" color="text-status-success">↑ 2 new this month</Box>
        </Container>

        <Container header={<Header variant="h2">Total Vehicles</Header>}>
          <Box variant="h1" color="text-status-success">{totalVehicles}</Box>
          <Box variant="small" color="text-body-secondary">Across all fleets</Box>
          <Box variant="small" color="text-status-info">↑ 8% from last month</Box>
        </Container>

        <Container header={<Header variant="h2">Average Fleet Size</Header>}>
          <Box variant="h1" color="text-status-info">{averageFleetSize}</Box>
          <Box variant="small" color="text-body-secondary">Vehicles per fleet</Box>
          <Box variant="small" color="text-status-success">Optimal range: 15-25</Box>
        </Container>

        <Container header={<Header variant="h2">Fleet Utilization</Header>}>
          <Box variant="h1" color="text-status-success">87%</Box>
          <Box variant="small" color="text-status-success">↑ 5% from last week</Box>
          <Box variant="small" color="text-body-secondary">Average across active fleets</Box>
        </Container>
      </Grid>
