...
const OEM1EnrollmentPanel: React.FC<OEM1EnrollmentPanelProps> = ({ vehicle, vin, canRefresh }) => {
  ...
  // enrolled_at, last_seen_at, status, oem1_status_refreshed_at.
  const enrolledAt = (vehicle as any).enrolled_at || (vehicle as any).enrolledAt;
  const lastSeenAt = (vehicle as any).last_seen_at || (vehicle as any).lastSeenAt;
                ...
                <>
                  <span
                    title={
                      !simReachable
                        ...
                        : vehicleData?.has_certificate === false
                  ...
                  >
                    <Button
                      ...
                      disabled={!simReachable || vehicleData?.has_certificate === false}
                        ...
                        <SpaceBetween size="l">
                          ...
                          <ColumnLayout columns={4} variant="text-grid">
                            ...
                            <SpaceBetween direction="vertical" size="xs">
                              ...
                              {(() => {
                                // OEM1: enrolled_at present means enrolled; status drives active/inactive
                                const enrolledAt = (vehicleData as any).enrolled_at || (vehicleData as any).enrolledAt;
                              ...
                              <SpaceBetween direction="vertical" size="xs">
                                {isOEM1 ? (
                                  <>
                                    ...
                                    <div>{(() => {
                                      const ts = (vehicleData as any).last_seen_at || (vehicleData as any).lastSeenAt;
                                      if (!ts) return 'Never';
                                      const d = new Date(ts);
                            ...
                            <div>
                              ...
                              <div>{(() => {
                                const ts = isOEM1
                                  ? ((vehicleData as any).last_seen_at || (vehicleData as any).lastSeenAt)
