...
import { FleetSummary } from "@/api/fleet-management-client";
    ...
    if (vehicle) {
      ...
      async function fetchFleetsForVehicle(vehicleName: string) {
        try {
          ...
          console.warn(`ListFleetsForVehicleCommand not available for vehicle: ${vehicleName}`, error);
          // Fallback: create a mock fleet data or set to null
          setData(null);
          setDataStatus("finished");
        }
      }
