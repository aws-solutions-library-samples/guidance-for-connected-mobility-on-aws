...
type UserContextType = {
  ...
  managedService: ManagedServiceType;
};
...
export const UserContextProvider = ({
  ...
  const [isManagedServiceEnabled, setIsManagedServiceEnabled] = useLocalStorage<boolean>(
    "UserContext_managedService",
    false,
  );
  
  // Log the initial value of the managed service toggle
  console.log("Initial managed service state:", isManagedServiceEnabled);
  ...
  const managedService = {
    isEnabled: isManagedServiceEnabled,
    setIsEnabled: (isEnabled: boolean) => {
      console.log("Setting managed service state:", isEnabled);
      setIsManagedServiceEnabled(isEnabled);
    },
  };
  ...
  const contextValue = useMemo(
    ...
    [fleet, vehicle, theme, demoMode, managedService],
  );
