...
EVENT_CATALOG = {
    ...
    "safety.phone_usage": {"category": "safety", "severity": 2},
    "safety.tailgating": {"category": "safety", "severity": 2},
    "safety.unsafe_lane_change": {"category": "safety", "severity": 2},
    "safety.drowsy_driving": {"category": "safety", "severity": 3},
    "safety.speeding": {"category": "safety", "severity": 2},
    "safety.aeb_activation": {"category": "safety", "severity": 3},
    "safety.esc_activation": {"category": "safety", "severity": 2},
    "safety.lane_departure": {"category": "safety", "severity": 2},
    ...
    "maintenance.low_fuel": {"category": "maintenance", "severity": 1},
    "maintenance.low_oil_pressure": {"category": "maintenance", "severity": 2},
    "maintenance.high_engine_temp": {"category": "maintenance", "severity": 3},
    "maintenance.tire_tread_low": {"category": "maintenance", "severity": 2},
    "maintenance.brake_wear": {"category": "maintenance", "severity": 2},
    "maintenance.oil_life_low": {"category": "maintenance", "severity": 1},
    "maintenance.filter_replacement": {"category": "maintenance", "severity": 1},
}
